...
@Component({
  selector: 'hive-force-creature-tool-asset',
  templateUrl: './creature-tool-asset.component.html',
  styleUrls: ['./creature-tool-asset.component.scss']
})
export class CreatureAssetComponent {
  @Input() creatureAsset = null
